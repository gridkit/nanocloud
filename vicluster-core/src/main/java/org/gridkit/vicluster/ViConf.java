...
public class ViConf extends GenericConfig implements ViSpiConfig {
    ...
    public static final String NODE_TYPE__IN_PROCESS = ViProps.NODE_TYPE_IN_PROCESS;
    ...
    public static class TypeConf extends Delegate {
        ...
        public TypeConf setInProcess() {
            conf.setProp(NODE_TYPE, NODE_TYPE__IN_PROCESS);
            return this;
        }
    ...
    public static class JvmConf extends Delegate {
        ...
        public JvmConf addAgent(File agentJar, String options){
            conf.setProp(JVM_AGENT + ANON_COUNTER.incrementAndGet(), agentJar.getAbsolutePath() + "=" + (options == null ? "" : options));
            return this;
        }
        ...
        public JvmConf addProcessListener(ProcessLifecycleListener pll) {
            addProcessListener("PLL" + ANON_COUNTER.getAndIncrement(), pll);
            return this;
        }

        public JvmConf addProcessListener(String id, ProcessLifecycleListener pll) {
            conf.setConfigElement(JVM_PROCESS_LIFECYCLE_LISTENER + id, pll);
            return this;
        }
    }
