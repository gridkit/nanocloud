...
public class TunnelInitiatorTest extends LocalControlConsoleTest {
    ...
    private SimpleTunnelInitiator initiator = new SimpleTunnelInitiator(System.getProperty("java.home") + File.separator + "bin" + File.separator + "java", BackgroundStreamDumper.SINGLETON, ZLogFactory.getStdErrRootLogger());
